(function() {
    ...
    //,  filesync = require('./filesync') //Node deps
    Cookies = require('cookies');

    var dbsync = require('./couchDbsync');
//callback()

    //TODO remove deps of fs.js in filesync, into design doc js

    if( typeof module !== 'undefined' && module.exports) {
        module.exports = i18n;
    }

    var resStore, backend, orgInit = i18n.init, registeredAppHelpers;
    ...
    i18n.init = function(options, cb) {
        ...
        if(!backend)
            backend = dbsync;
        //extend (&replace?) i18n.sync with attr from backend
    ...
    i18n.handle = function(req, res, next) {
        ...
        i18n.setLng(locale, function() {
            if(i18n.options.useCookie)
                i18n.persistCookie(req, res, i18n.lng());
            next();
        });
    };

    //TODO output as commonjs module and be loaded?
    ...
    i18n.serveDynamicResources = function(app, options) {
        ...
        app.get('/locales/resources.json', function(req, res) {
            ...
            var languages = req.query.lng ? req.query.lng.split(' ') : [], opts = {
                ns : {
                    namespaces : req.query.ns ? req.query.ns.split(' ') : []
                }
            };
            ...
            i18n.sync.load(languages, opts, function() {
                ...
                languages.forEach(function(lng) {
                    ...
                    opts.ns.namespaces.forEach(function(ns) {
                        if(!resources[lng][ns])
                            resources[lng][ns] = resStore[lng][ns] || {};
                    });
                });
    ...
    i18n.persistCookie = function(req, res, locale) {
        ...
        cookies.set(i18n.options.cookieName, locale, {
